Translation of the Python Documentation — si
============================================

.. image:: https://travis-ci.org/python/python-docs-si.svg?branch=3.12
  :target: https://travis-ci.org/python/python-docs-si
...
- Or just by opening `an issue on github <https://github.com/python/python-docs-si/issues>`_
...
You'll need to fork the `python-docs-si
<https://github.com/python/python-docs-si>`_ clicking its ``Fork``
...
.. code-block:: bash
    ...
    git clone git@github.com:JulienPalard/python-docs-si.git

    # Go to the cloned directory:
    cd python-docs-si/

    # Add the upstream (the public repository) using HTTPS (won't ask for password):
    git remote add upstream https://github.com/python/python-docs-si.git
...
.. code-block:: bash
    ...
    # https://github.com/python/python-docs-si/ and a nice "Compare & pull request"
...
All those snippets are to run from the root of a ``python-docs-si``
